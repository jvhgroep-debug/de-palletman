...
export const palletsKopen: ServicePageContent = {
  path: "/pallets-kopen",
  seo: {
    title: "Gebruikte pallets kopen | Europallets & blokpallets | De Palletman",
    description:
  ...
  hero: {
    eyebrow: "Pallets kopen",
    title: "Gebruikte pallets kopen voor uw bedrijf",
    subtitle:
