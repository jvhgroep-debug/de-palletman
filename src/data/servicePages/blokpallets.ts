...
export const blokpallets: ServicePageContent = {
    ...
    items: [
      {
        ...
        text: "Wij leveren blokpallets uitsluitend aan bedrijven — professioneel en betrouwbaar.",
      },
      {
        title: "Grote én kleine partijen",
        text: "Van enkele pallets tot grotere volumes — wij leveren passend bij uw vraag.",
      },
      {
        title: "Eigen transport",
        text: "Bezorging en ophalen met eigen transport in ons werkgebied.",
      },
      {
        title: "Duurzaam alternatief",
        text: "Gebruikte blokpallets zijn kostenefficiënt en dragen bij aan circulair hergebruik.",
  ...
  faq: {
    ...
    items: [
      ...
      {
        question: "Waarvoor zijn blokpallets geschikt?",
        answer:
          "Blokpallets zijn ontworpen voor zware ladingen en industriële toepassingen in magazijnen en productie.",
      },
      {
        question: "Kopen jullie ook blokpallets in?",
        answer:
          "Ja. Wij kopen blokpallets in van bedrijven en particulieren. Neem contact op voor een prijsopgave.",
      },
      {
