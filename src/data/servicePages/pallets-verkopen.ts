...
export const palletsVerkopen: ServicePageContent = {
  ...
  hero: {
    eyebrow: "Pallets verkopen",
    title: "Verkoop uw gebruikte pallets",
    subtitle:
  ...
  faq: {
    ...
    intro: "Antwoorden op de meest gestelde vragen van bedrijven en particulieren die pallets willen verkopen.",
    variant: "white",
    items: [
      {
