    ...
    items: [
      {
        ...
        text: "Wij leveren europallets uitsluitend aan bedrijven — professioneel, snel en betrouwbaar.",
      },
      {
      ...
      },
      {
        ...
        text: "Bezorging bij u op locatie met eigen transport. Flexibel en efficiënt.",
      },
      {
        title: "In- en verkoop",
        text: "Overtollige europallets? Wij kopen ook in van bedrijven en particulieren.",
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          "A-kwaliteit (eerste keus) zijn lichte of blanke pallets met een nette uitstraling. B-kwaliteit (tweede keus) zijn donkerder met normale gebruikssporen, maar technisch volledig bruikbaar.",
      },
      {
        question: "Leveren jullie HT-gestempelde europallets?",
        answer:
          "Ja. Voor export buiten de EU zijn HT-gestempelde pallets leverbaar volgens ISPM 15.",
      },
      {
        question: "Kopen jullie ook europallets in?",
        answer:
          "Ja. Wij kopen europallets in van bedrijven en particulieren. Neem contact op voor een prijsopgave.",
      },
      {
        question: "Bezorgen jullie met eigen transport?",
        answer:
          "Ja, in ons werkgebied: Noord-Brabant, Zuid-Holland, Zeeland, Limburg, Utrecht en Gelderland.",
      },
      {
        question: "Hoe vraag ik een offerte aan?",
        answer:
          "Neem contact op via telefoon, WhatsApp of onze contactpagina. Vermeld aantal en gewenste kwaliteit.",
      },
    ],
  },
  cta: {
